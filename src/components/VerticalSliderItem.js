                        ...
                        <div className={classes.quesTags}> 
                            {data.topics.map((tag,i) => (
                                ...
                                <Link to={"/allquestions/"+ tag.slug}>
                                    <Tag key={uuid()} style={{color: colors.tagColor[Math.floor(Math.random() * colors.tagColor.length)] , bgColor: colors.tagBgColor[Math.floor(Math.random() * colors.tagBgColor.length)]}} data={tag}/>
                               </Link>
                               </>
                            ))}
                        </div>
                ...
                <Row className="align-items-center">    
                    <div className={classes.ansDescrip}>
                        ...
                        {<div className={classes.readMoreBtn}>
                            <Link to={"/singlequestion/"+ data.slug} target="_blank">
